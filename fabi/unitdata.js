...
const a = new LeichterJaeger();
const b = new SchwererJaeger();
const c = new MiningDrohne();
const d = new Bomber();
const e = new Fregatte();
const ff = new Zerstörer();
const g = new Kreuzer();
const h = new BergBauSchiff();
const i = new FlugDeckKreuzer();
const j = new GrosserTransporter();
const k = new SchlachtSchiff();
const l = new SchlachtKreuzer();
const m = new TrägerSchiff();
const n = new KolonieSchiff();



const o = new Zerstörer();
const p = new FlugDeckKreuzer();
const q = new Kreuzer();
const r = new Bomber();
const s = new LeichterJaeger();
const t = new LeichterJaeger();
const u = new SchlachtSchiff();
const v = new LeichterJaeger();
...
let bomberarray = [];
for (let i = 0; i < 22; i++) {
  let bomberinstance = new Bomber();
  bomberarray.push(bomberinstance);
  let schlachtkreuzerinstance = new SchlachtKreuzer();
  bomberarray.push(schlachtkreuzerinstance);
}
for (let i = 0; i < 100; i++) {
  let leichterJaegerInstance = new LeichterJaeger();
  leichterJaegerArray.push(leichterJaegerInstance);
}
for (let i = 0; i < 100; i++) {
